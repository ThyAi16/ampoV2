...
test.describe('Verify login', () => {
   ...
   test('Testcase 2: The phone number does not exist', async({page}) => {
    await page.waitForTimeout(1000);
   ...
   test('Testcase 8: Phone numbers contain specical charaters', async({page}) => {
    await page.waitForTimeout(1000);
   ...
   test('Testcase 14: Password is emptry', async({page}) => {
    await page.waitForTimeout(1000);
    await page.getByPlaceholder('Nhập số điện thoại').fill('0352864299');
